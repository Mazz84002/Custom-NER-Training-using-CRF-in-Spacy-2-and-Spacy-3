...
if spacy_version() == 2:
    nlp = spacy.load("en_core_web_md", vectors='/Users/mazz/Documents/Programming/Python/Mini-Project/Script/Fastext_models/fastext') # to import spacy tokenizer
...
for p in range(0, 3):
    ...
    def read_examples(file, tokenizer, use_dense_features=False, limit=100):
        examples = []
        it = read_file(file)
